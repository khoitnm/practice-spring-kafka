 ...
 *
 * @Note We may not need this class to prevent endless loop in consumer because the {@link org.tnmk.practicespringkafka.common.kafka.consumer.KafkaGlobalContainerErrorHandler} will be automatically registered into KafkaListenerContainer (view more in the code {@link org.tnmk.practicespringkafka.common.kafka.consumer.KafkaListenerContainerFactoryConstructor}).
