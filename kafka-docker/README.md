This folder is cloned from `https://github.com/wurstmeister/kafka-docker`.
View more about connection at `https://github.com/wurstmeister/kafka-docker/wiki/Connectivity`.

Start Kafka server by using one of following scripts:
- `simple_start.sh`
- `many-brokers_start.sh`
